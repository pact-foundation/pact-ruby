...
| Version   | Platform             |
|-----------|----------------------|
| 0.5.8.1  | x86_64-darwin        |
| 0.5.8.1  | arm64-darwin         |
| 0.5.8.1  | x86_64-linux         |
| 0.5.8.1  | aarch64-linux        |
| 0.5.8.1  | x86_64-linux-musl    |
| 0.5.8.1  | aarch64-linux-musl   |
| 0.5.8.1  | x64-mingw32          |
| 0.5.8.1  | x64-mingw-ucrt       |
...
1. add `gem "pact-ffi", "~> 0.5.8"` to Gemfile, or Gemspec

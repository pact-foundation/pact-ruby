...
Gem::Specification.new do |gem|
  ...
  gem.email         = ['james.fraser@alumni.swinburne.edu', 'sergei.matheson@gmail.com', 'brent@fuglylogic.com',
                       'uglyog@gmail.com', 'bskurrie@dius.com.au']
  gem.description   = 'Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.' # rubocop:disable Layout/LineLength
  gem.summary       = 'Enables consumer driven contract testing, providing a mock service and DSL for the consumer project, and interaction playback and verification for the service provider project.' # rubocop:disable Layout/LineLength
  ...
  # std gems dropped from various ruby versions and not updated in deps

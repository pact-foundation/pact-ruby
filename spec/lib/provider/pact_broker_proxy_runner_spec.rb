...
describe Pact::Provider::PactBrokerProxyRunner do
  ...
  context 'with pact data request' do
    let(:request_url) do
      "#{proxy_host}/pacts/provider/paas-stand-seeker/consumer/paas-stand-placer/pact-version/2967a9343bd8fdd28a286c4b8322380020618892/metadata/c1tdW2VdPXByb2R1Y3Rpb24mc1tdW2N2XT03MzIy" # rubocop:disable Layout/LineLength
    end
